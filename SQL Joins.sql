...
/* joins: find the product name, total # sold, and total price sold,
 ...
 SELECT  products.Name, SUM(sales.Quantity) AS Total_Sold, products.Price * SUM(sales.Quantity) AS Total_Price_Sold 
 FROM sales
...
This query should return the employeeID, the employee's first and last name, the name of each product, how many of that product they sold */
 SELECT employees.EmployeeID, employees.FirstName, employees.LastName, products.Name, SUM(sales.Quantity) AS Total_Sales
 FROM sales
